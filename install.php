    ...
    <div class="install-card">
      <?php if ($success): ?>
        ...
        <div class="install-success">
          ระบบถูกติดตั้งเรียบร้อยแล้ว ฐานข้อมูลถูกสร้างพร้อมข้อมูลตัวอย่าง<br><br>
          <strong>บัญชีทดสอบ:</strong><br>
          STD001–STD005 / รหัสผ่าน 1234 (นักศึกษาฝึกงาน)<br>
          TEACHER01 / รหัสผ่าน 1234 (ครูนิเทศ)<br>
          ADMIN / รหัสผ่าน 1234 (ผู้ดูแลระบบ)
        </div>
